...
class NiceCover(CoverEntity):
    ...
    async def async_set_cover_position(self, **kwargs) -> None:
        ...
        if self._has_reverse_semantics:
            pos: int = 1000 - (kwargs[ATTR_POSITION] * 10)  # pos of 1000 is fully up
        else:
    ...
    async def async_set_drop_percent(self, drop_percent_scaled: float) -> None:
        ...
        if self._has_reverse_semantics:
            pos = 1000 - round(drop_percent_scaled * 10.0)  # pos of 1000 is fully up
        else:
    ...
    async def handle_update(self):
        ...
        drop_percent_scaled = self._attr_current_cover_position
